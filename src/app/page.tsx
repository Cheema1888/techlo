...
export default function HomePage() {
  ...
  return (
    <div className="space-y-16 lg:space-y-20 pb-20 font-mono">
      {/* 1. HERO SECTION (REAL LOGIN STATUS & MARKETPLACE FOCUSED) */}
      <section className="relative overflow-hidden pt-10 pb-16 lg:pt-14 lg:pb-20 border-b border-neutral-200 dark:border-neutral-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-5">
            {/* Live User Login Status Banner */}
            {isAuthenticated && user ? (
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-neutral-300 dark:border-neutral-800 bg-white dark:bg-[#0c0c0c] text-xs text-neutral-800 dark:text-neutral-200 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                <span>Signed in as <strong>{user.fullName}</strong> ({user.university})</span>
                <span className="text-neutral-400">|</span>
                <span className="text-neutral-500">{user.phoneNumber}</span>
              </div>
            ) : (
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-300 dark:border-neutral-800 bg-white dark:bg-[#0c0c0c] text-[11px] text-neutral-800 dark:text-neutral-300 shadow-sm">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black dark:text-white tracking-tight leading-[1.12]">
              Buy, Sell & Trade Hardware Components
            </h1>

            {/* Subheading */}
            <p className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400 max-w-xl mx-auto leading-relaxed font-sans">
              Pakistan&apos;s verified university network for engineering students to trade <strong>ESP32, STM32, sensors, motors, and lab tools</strong> — with on-demand <strong>PCB Design, Fabrication & 3D CAD services</strong>.
            </p>
            ...
            <div className="max-w-xl mx-auto pt-2">
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-transparent text-black dark:text-white text-xs placeholder-neutral-400 dark:placeholder-neutral-500 focus:outline-none"
                />
                <button
                  type="submit"
                  className="px-4 py-2 bg-black dark:bg-white hover:bg-neutral-800 dark:hover:bg-neutral-200 text-white dark:text-black font-bold text-xs rounded-xl transition-all cursor-pointer flex-shrink-0"
                >
                  Search
                </button>
              </form>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              ...
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-white dark:bg-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 border border-neutral-300 dark:border-neutral-800 text-black dark:text-white font-bold text-xs transition-all flex items-center gap-2 cursor-pointer"
                >
                  <User className="w-3.5 h-3.5" />
                  <span>Sign In with University & Phone</span>
                </button>
              )}
            ...
            {/* Live Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-6 border-t border-neutral-200 dark:border-neutral-800 max-w-3xl mx-auto text-left">
              <div className="p-3 bg-white dark:bg-[#0a0a0a] rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                <span className="block text-lg font-bold text-black dark:text-white">Live DB</span>
                <span className="text-[10px] text-neutral-500">Prisma + SQLite</span>
              </div>
              <div className="p-3 bg-white dark:bg-[#0a0a0a] rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                <span className="block text-lg font-bold text-black dark:text-white">20+</span>
                <span className="text-[10px] text-neutral-500">Universities</span>
              </div>
              <div className="p-3 bg-white dark:bg-[#0a0a0a] rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
              ...
              <div className="p-3 bg-white dark:bg-[#0a0a0a] rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                ...
                <span className="text-[10px] text-neutral-500">PCB / 3D Turnaround</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 2. MAIN HIGHLIGHT: REAL DATABASE HARDWARE MARKETPLACE */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <Link
            href="/marketplace"
            className="text-xs font-bold text-black dark:text-white hover:underline inline-flex items-center gap-1"
          >
            <span>Browse All {products.length} Items in Database</span>
            <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="p-12 text-center bg-white dark:bg-[#0a0a0a] rounded-2xl border border-neutral-200 dark:border-neutral-800 space-y-3 shadow-sm">
            <Cpu className="w-10 h-10 text-neutral-400 mx-auto" />
            <h3 className="text-sm font-bold text-black dark:text-white">No items found in this category</h3>
            <p className="text-xs text-neutral-500 font-sans">Be the first student to post hardware in your university!</p>
            <Link
              href="/sell"
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-black dark:bg-white text-white dark:text-black rounded-xl text-xs font-bold shadow-sm"
            >
              <Plus className="w-3.5 h-3.5" />
              <span>Post Hardware Item</span>
            </Link>
        ...
        {/* Post Hardware Banner */}
        <div className="p-6 rounded-2xl bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 pt-6 border-t border-neutral-200 dark:border-neutral-800">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <Link
            href="/services/request"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-black dark:bg-white hover:bg-neutral-800 dark:hover:bg-neutral-200 text-white dark:text-black font-bold text-xs shadow-sm"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-600 transition-all space-y-2.5 shadow-sm">
            ...
            <Link href="/services#pcb-design" className="text-[11px] text-neutral-700 dark:text-neutral-300 inline-flex items-center gap-1 hover:underline pt-1">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-600 transition-all space-y-2.5 shadow-sm">
            ...
            <Link href="/services#pcb-fabrication" className="text-[11px] text-neutral-700 dark:text-neutral-300 inline-flex items-center gap-1 hover:underline pt-1">
              Details <ArrowUpRight className="w-3 h-3" />
            </Link>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-600 transition-all space-y-2.5 shadow-sm">
            ...
            <Link href="/services#cad-modeling" className="text-[11px] text-neutral-700 dark:text-neutral-300 inline-flex items-center gap-1 hover:underline pt-1">
              Details <ArrowUpRight className="w-3 h-3" />
            </Link>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-600 transition-all space-y-2.5 shadow-sm">
            ...
            <Link href="/services#3d-printing" className="text-[11px] text-neutral-700 dark:text-neutral-300 inline-flex items-center gap-1 hover:underline pt-1">
              Details <ArrowUpRight className="w-3 h-3" />
            </Link>
          </div>
        </div>
