...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="group relative flex flex-col bg-white dark:bg-[#0a0a0a] hover:bg-neutral-50 dark:hover:bg-[#0e0e0e] border border-neutral-200 dark:border-neutral-800 hover:border-black dark:hover:border-neutral-600 rounded-2xl overflow-hidden transition-all duration-200 shadow-sm hover:shadow-md">
      ...
      <div className="relative aspect-[4/3] w-full overflow-hidden bg-neutral-100 dark:bg-[#141414]">
        ...
        <div className="absolute bottom-2.5 left-2.5 right-2.5 flex items-end justify-between">
          <div className="px-2 py-0.5 rounded bg-white/95 dark:bg-black/90 border border-neutral-200 dark:border-neutral-800 text-black dark:text-white font-mono font-bold text-xs shadow-sm">
          ...
          {product.originalPricePkr && (
            <span className="text-[9px] text-neutral-400 dark:text-neutral-500 line-through bg-white/90 dark:bg-black/80 px-1 py-0.5 rounded font-mono">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
        ...
        <div className="pt-2 border-t border-neutral-100 dark:border-neutral-800 space-y-2 text-xs">
          {/* Campus Tag */}
          <div className="flex items-center gap-1 text-neutral-600 dark:text-neutral-400 font-mono text-[11px]">
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <div className="text-[10px] font-mono text-neutral-500 dark:text-neutral-400 font-bold">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1 font-mono text-xs">
          <Link
            ...
            className="w-full py-1.5 px-2 rounded-lg bg-neutral-100 dark:bg-neutral-900 hover:bg-neutral-200 dark:hover:bg-neutral-800 border border-neutral-200 dark:border-neutral-800 text-neutral-800 dark:text-neutral-200 flex items-center justify-center gap-1 transition-colors"
          >
            <span>Details</span>
          ...
          <a
            ...
            className="w-full py-1.5 px-2 rounded-lg bg-black dark:bg-white hover:bg-neutral-800 dark:hover:bg-neutral-200 text-white dark:text-black font-bold flex items-center justify-center gap-1 transition-colors shadow-sm"
          >
